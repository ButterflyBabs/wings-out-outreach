...
// POST for manual triggering (no auth required)
export async function POST(request: NextRequest) {
  try {
    console.log('Starting manual AI research...');
    ...
    return NextResponse.json({
      success: true,
      message: `Research complete! Imported ${results.imported} companies, skipped ${results.skipped} duplicates.`,
      results
    });
